...
class CardsScreen extends StatefulWidget {
  ...
  const CardsScreen({super.key, required this.categoryId});
  @override
...
class _CardsScreenState extends State<CardsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      .where((card) => card.categoryId == widget.categoryId)
      .toList();
                        ...
                        cardBuilder: (context, index, horizontalThreshold, verticalThreshold) {
                          ...
                          return FlashcardWidget(
                            ...
                            onMarkAsLearned: () async {
                              ...
                              if (index < cards.length) {
                                await flashcardController.toggleLearned(card);
                                Get.snackbar(
                                  "Great!",
                        ...
                        child: Padding(
                          ...
                          child: FlashcardWidget(
                            ...
                            onMarkAsLearned: () async {
                              ...
                              await flashcardController.toggleLearned(firstcard);
                              Get.snackbar(
                                "Great!",
                                "Card marked as learned! 🎉",
                                snackPosition: SnackPosition.BOTTOM,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Get.to(() => AddCardScreen(categoryId: widget.categoryId,)),
        backgroundColor: Colors.blue,
